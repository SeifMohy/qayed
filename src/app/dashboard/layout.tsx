...
import { BanknotesIcon, UsersIcon, TruckIcon, ChartBarIcon, UserCircleIcon, CreditCardIcon, ClipboardDocumentCheckIcon, CpuChipIcon } from '@heroicons/react/24/outline'
