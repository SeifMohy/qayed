...
export async function getUserCompanyId(supabaseUserId) {
    try {
...
export async function verifyUserCompanyAccess(supabaseUserId, companyId) {
    try {
        const user = await prisma.user.findUnique({
            where: { supabaseUserId },
            select: { companyId: true }
...
export async function getOrCreateUserCompany(supabaseUserId, companyName) {
    try {
...
//# sourceMappingURL=companyAccessService.js.map