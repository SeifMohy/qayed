...
function mapCategoryToEnum(categoryString) {
...
async function classifyTransactionsBatch(transactions) {
 ...
 */
export async function classifyBankStatementTransactions(bankStatementId) {
    const API_KEY = getApiKey();
    if (!API_KEY) {
        throw new Error('Gemini API key not configured');
    }
