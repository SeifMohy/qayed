 ...
 */
export async function normalizeNames(names) {
...
- Only return valid JSON, no additional text or explanations`;
        ...
        for (const name of names) {
            const result = parsedResult.results.find((r) => r.id === name.id);
 ...
 */
export function isNameNormalizationAvailable() {
    return !!process.env.GEMINI_API_KEY;
}
//# sourceMappingURL=nameNormalizationService.js.map